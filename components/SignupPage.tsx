        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-[420px] bg-card border border-border rounded-3xl p-8 sm:p-10 shadow-2xl shadow-primary/5 relative z-10 transition-all">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-foreground mb-2 tracking-tight">Create Account</h1>
                    <p className="text-muted-foreground">Start your journey to English mastery</p>
                </div>
